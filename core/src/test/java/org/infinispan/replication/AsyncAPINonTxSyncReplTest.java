...
public class AsyncAPINonTxSyncReplTest extends MultipleCacheManagersTest {
   ...
   protected void assertEquals(Future f, Object o) throws ExecutionException, InterruptedException {
      Util.safeEquals(f.get(), o);
   }
