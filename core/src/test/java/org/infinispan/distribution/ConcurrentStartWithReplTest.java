...
public class ConcurrentStartWithReplTest extends AbstractInfinispanTest {
   ...
   private void doTest(boolean inOrder, boolean nonBlockingStartupForDist) throws ExecutionException, InterruptedException {
      EmbeddedCacheManager cm1 = TestCacheManagerFactory.createCacheManager(GlobalConfigurationBuilder.defaultClusteredBuilder(), new ConfigurationBuilder());
      EmbeddedCacheManager cm2 = TestCacheManagerFactory.createCacheManager(GlobalConfigurationBuilder.defaultClusteredBuilder(), new ConfigurationBuilder());
      try {
