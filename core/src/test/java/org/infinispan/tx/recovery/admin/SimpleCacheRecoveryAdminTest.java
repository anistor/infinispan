...
public class SimpleCacheRecoveryAdminTest extends AbstractRecoveryTest {
   ...
   protected void createCacheManagers() throws Throwable {
      ...
      configuration.transaction().transactionManagerLookup(new RecoveryDummyTransactionManagerLookup())
            ...
            .l1().disable();
      EmbeddedCacheManager cm1 = TestCacheManagerFactory.createCacheManager(createGlobalConfigurationBuilder(), configuration, true);
      EmbeddedCacheManager cm2 = TestCacheManagerFactory.createCacheManager(createGlobalConfigurationBuilder(), configuration, true);
      EmbeddedCacheManager cm3 = TestCacheManagerFactory.createCacheManager(createGlobalConfigurationBuilder(), configuration, true);
