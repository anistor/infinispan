 ...
 * <p>
 * Please see the <a href="http://infinispan.org/documentation/">Infinispan documentation</a> and/or the
 * <a href="http://infinispan.org/docs/dev/getting_started/getting_started.html">5 Minute Usage Tutorial</a> for more
 * details on Infinispan.
 * <p>
 * MultimapCache is a type of Infinispan Cache that maps keys to values, similar to {@link
 ...
 *     multimapCache.remove("k", "v1").join() -> works, removes v1 and as the remaining collection is empty, the key is removed
...
public interface BasicMultimapCache<K, V> {
    ...
    * @return a {@link CompletableFuture} containing {@link Collection Collection&lt;V&gt;} which is a view of the
    * underlying values.
    * @since 9.2
    */
   ...
   /**
    * Multimap can support duplicates on the same key {@code k -> ['a', 'a', 'b']} or not {@code k -> ['a', 'b']}
