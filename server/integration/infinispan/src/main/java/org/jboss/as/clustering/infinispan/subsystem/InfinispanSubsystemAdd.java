...
import org.infinispan.server.infinispan.query.ClassRegistryProcessor;
   ...
   private void addDeployableExtensionProcessors(OperationContext context) {
      context.addStep(new AbstractDeploymentChainStep() {
        ...
        protected void execute(DeploymentProcessorTarget processorTarget) {
            ...
            processorTarget.addDeploymentProcessor(INFINISPAN_SUBSYSTEM_NAME, Phase.POST_MODULE, ++basePriority, new ClassRegistryProcessor());
      ...
      context.getServiceTarget().addService(ClassRegistryService.SERVICE_NAME, new ClassRegistryService()).install();
   }
